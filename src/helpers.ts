...
export function initializeBoardVariant(
  ...
  if (variant == 'pickaxe') {
    ...
    if (playerCount == 2) {
      board[boardHeight - 2][boardWidth - 2].player = structuredClone(players[1]);
    ...
    if (playerCount >= 3) {
      board[1][boardWidth - 2].player = structuredClone(players[1]);
      split(boardWidth - 2, 1, board);
      split(boardWidth - 1, 1, board);
      split(boardWidth - 2, 0, board);
      board[boardHeight - 2][boardWidth - 2].player = structuredClone(players[2]);
      split(boardWidth - 2, boardHeight - 2, board);
      split(boardWidth - 1, boardHeight - 2, board);
      split(boardWidth - 2, boardHeight - 1, board);
    }
    ...
    if (playerCount >= 4) {
      board[boardHeight - 2][1].player = structuredClone(players[3]);
